...
N 350 20 360 20 {lab=#net3}
N 360 -10 360 20 {lab=#net3}
N 240 -10 360 -10 {lab=#net3}
N 240 -40 240 -10 {lab=#net3}
N 240 -40 250 -40 {lab=#net3}
...
C {JNW_ATR_SKY130A/JNWATR_NCH_4C1F2.sym} -260 220 0 0 {name=x4 }
...
C {devices/lab_wire.sym} -310 220 0 0 {name=p2 sig_type=std_logic lab=OUT}
...
C {JNW_TR_SKY130A/JNWTR_CAPX4.sym} -110 250 0 0 {name=x3[9:0]}
