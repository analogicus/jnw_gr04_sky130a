...
N -210 -0 -60 -0 {lab=Vref}
N -470 30 -60 30 {lab=I_PTAT}
C {devices/res.sym} -210 -100 0 0 {name=R1
value=8k
footprint=1206
device=resistor
m=1}
C {devices/res.sym} -210 80 0 0 {name=R2
value=10k
footprint=1206
device=resistor
m=1}
...
C {devices/lab_wire.sym} -210 0 0 0 {name=p5 sig_type=std_logic lab=Vref}
C {JNW_GR04_SKY130A/PTAT.sym} -620 30 0 0 {name=x2}
C {devices/lab_wire.sym} -210 140 0 0 {name=p6 sig_type=std_logic lab=VSS
}
C {JNW_ATR_SKY130A/JNWATR_NCH_2C1F2.sym} -260 220 0 0 {name=x4[1:0]}
C {devices/lab_wire.sym} -530 290 0 0 {name=p7 sig_type=std_logic lab=VSS
}
C {devices/lab_wire.sym} -350 30 0 0 {name=p8 sig_type=std_logic lab=I_PTAT}
...
C {JNW_TR_SKY130A/JNWTR_CAPX4.sym} -110 250 0 0 {name=x3[3:0]}
