...
N -350 30 -90 30 {lab=#net1}
N -470 160 -470 190 {lab=#net1}
N -470 160 -360 160 {lab=#net1}
N -360 160 -360 190 {lab=#net1}
N -360 30 -360 160 {lab=#net1}
...
C {devices/ipin.sym} -560 220 0 0 {name=p2 lab=RST}
