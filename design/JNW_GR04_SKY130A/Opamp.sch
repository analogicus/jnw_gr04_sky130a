...
N -250 -380 -130 -380 {lab=#net4}
N -290 -350 -290 -320 {lab=#net4}
...
N 200 -350 200 90 {lab=#net5}
N 360 -350 360 -70 {lab=Vo}
N 230 -380 320 -380 {lab=#net5}
N 280 -380 280 -300 {lab=#net5}
N 200 -300 280 -300 {lab=#net5}
N -360 -100 -360 -70 {lab=#net5}
N -480 -100 -360 -100 {lab=#net5}
N -480 -100 -480 80 {lab=#net5}
N 200 80 200 90 {lab=#net5}
N -480 80 -480 90 {lab=#net5}
N -480 90 200 90 {lab=#net5}
...
N -290 -340 -200 -340 {lab=#net4}
N -200 -380 -200 -340 {lab=#net4}
...
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} -320 -40 0 1 {name=x5 }
C {JNW_ATR_SKY130A/JNWATR_PCH_4C1F2.sym} -140 -380 0 0 {name=x6 }
C {JNW_ATR_SKY130A/JNWATR_PCH_4C1F2.sym} -250 -380 0 1 {name=x7 }
C {JNW_ATR_SKY130A/JNWATR_PCH_4C1F2.sym} 240 -380 0 1 {name=x8 }
C {JNW_ATR_SKY130A/JNWATR_PCH_4C1F2.sym} 320 -380 0 0 {name=x9 }
