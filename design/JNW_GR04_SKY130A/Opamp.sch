...
S {}
E {}
N -20 -180 -20 -70 {lab=v3}
N -190 -180 -190 -70 {lab=#net1}
N -190 -260 -190 -240 {lab=v2}
N -190 -260 -20 -260 {lab=v2}
N -20 -260 -20 -240 {lab=v2}
N -190 -10 -190 10 {lab=VSS}
N -190 10 -20 10 {lab=VSS}
N -20 -10 -20 10 {lab=VSS}
N -100 -290 -100 -260 {lab=v2}
N -320 -40 -230 -40 {lab=#net1}
N -270 -100 -270 -40 {lab=#net1}
N -270 -100 -190 -100 {lab=#net1}
N -360 -10 -360 20 {lab=VSS}
N -250 -380 -130 -380 {lab=Vbias}
N -290 -350 -290 -320 {lab=Vbias}
N -100 -350 -100 -290 {lab=v2}
N 20 -40 130 -40 {lab=v3}
N -20 -100 70 -100 {lab=v3}
N 70 -100 70 -40 {lab=v3}
...
N 130 -40 320 -40 {lab=v3}
N 360 -460 360 -410 {lab=VDD}
N 200 -350 200 90 {lab=v4}
N 360 -350 360 -70 {lab=Vo}
N 230 -380 320 -380 {lab=v4}
N 280 -380 280 -300 {lab=v4}
N 200 -300 280 -300 {lab=v4}
N -360 -100 -360 -70 {lab=v4}
N -480 -100 -360 -100 {lab=v4}
N -480 -100 -480 80 {lab=v4}
N 200 80 200 90 {lab=v4}
N -480 80 -480 90 {lab=v4}
N -480 90 200 90 {lab=v4}
...
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 320 -40 0 0 {name=x10
}
...
C {devices/lab_pin.sym} -100 -290 0 0 {name=p6 sig_type=std_logic lab=v2
}
C {devices/lab_pin.sym} -20 -130 0 0 {name=p8 sig_type=std_logic lab=v3
}
C {devices/lab_pin.sym} 200 -180 0 0 {name=p9 sig_type=std_logic lab=v4

}
C {JNW_ATR_SKY130A/JNWATR_PCH_8C1F2.sym} -250 -380 0 1 {name=x5 }
C {JNW_ATR_SKY130A/JNWATR_PCH_8C1F2.sym} -140 -380 0 0 {name=x6 }
C {JNW_ATR_SKY130A/JNWATR_PCH_8C1F2.sym} 240 -380 0 1 {name=x7 }
C {JNW_ATR_SKY130A/JNWATR_PCH_8C1F2.sym} 320 -380 0 0 {name=x8 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} -230 -40 0 0 {name=x9 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C5F0.sym} 20 -40 0 1 {name=x1 }
