...
N -460 -660 310 -660 {lab=VDD}
N 310 -660 310 -570 {lab=VDD}
N -190 -660 -190 -570 {lab=VDD}
N 310 -570 310 -540 {lab=VDD}
N -190 -570 -190 -540 {lab=VDD}
N -40 -660 -40 -370 {lab=VDD}
...
user="wulff"
company="wulff"}
C {devices/ipin.sym} -460 -660 0 0 {name=p1 lab=VDD
}
C {devices/ipin.sym} -410 -80 0 0 {name=p2 lab=VSS}
