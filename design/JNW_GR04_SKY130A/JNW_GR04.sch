...
N -460 -660 310 -660 {lab=#net2}
N 310 -660 310 -570 {lab=#net2}
N -190 -660 -190 -570 {lab=#net2}
N 310 -570 310 -540 {lab=#net2}
N -190 -570 -190 -540 {lab=#net2}
N -40 -660 -40 -370 {lab=#net2}
N -380 -500 -380 -210 {lab=#net1}
N -380 -570 -380 -540 {lab=#net2}
...
N -190 -510 -190 -330 {lab=#net3}
N -190 -330 -40 -330 {lab=#net3}
N -380 -150 -380 -80 {lab=VSS}
N -420 -80 300 -80 {lab=VSS}
N -250 -100 -250 -80 {lab=VSS}
N -340 -180 -250 -180 {lab=#net4}
N -250 -180 -250 -160 {lab=#net4}
N -110 -350 -40 -350 {lab=VD1}
N 310 -510 310 -260 {lab=VD1}
N 300 -80 310 -80 {lab=VSS}
N -40 -310 -40 -80 {lab=VSS}
N -250 -420 -250 -180 {lab=#net4}
N -250 -450 270 -450 {lab=#net4}
N -380 -180 -380 -150 {lab=VSS}
N 310 -110 310 -80 {lab=VSS}
N 310 -200 310 -170 {lab=VD2}
N 310 -270 410 -270 {lab=VD1}
N 310 -190 420 -190 {lab=VD2}
N -190 -330 -190 -270 {lab=#net3}
N -190 -210 -190 -80 {lab=VSS}
N -110 -350 -110 -270 {lab=VD1}
N 270 -420 270 -340 {lab=#net4}
N 220 -340 270 -340 {lab=#net4}
N -250 -450 -250 -420 {lab=#net4}
N 270 -450 270 -420 {lab=#net4}
N -110 -270 -110 -200 {lab=VD1}
N -110 -200 240 -200 {lab=VD1}
N 240 -270 240 -200 {lab=VD1}
N 240 -270 310 -270 {lab=VD1}
N -380 -660 -380 -570 {lab=#net2}
N -150 -280 -150 -240 {lab=#net3}
N -190 -280 -150 -280 {lab=#net3}
N 350 -180 350 -140 {lab=VD2}
N 310 -180 350 -180 {lab=VD2}
N 310 -140 310 -110 {lab=VSS}
N -190 -240 -190 -210 {lab=VSS}
C {cborder/border_s.sym} 520 -30 0 0 {
user="wulff"
company="wulff"}
...
C {devices/iopin.sym} 410 -270 0 0 {name=p4 lab=VD1
}
C {devices/iopin.sym} 420 -190 0 0 {name=p5 lab=VD2}
